**Compile and Deploy ${TOKENSTANDARD}20 Contract**
...
3. Create new contract ${TOKENSTANDARD}20Token.sol and copy contract code from the ${tokenstandard}20 token template [here](${TOKENSTANDARD}20Token.template)
...
5. Compile the ${TOKENSTANDARD}20 token contract

a. Step1: Click button to switch to compile page

b. Step2: Select “${TOKENSTANDARD}20Token” contract
...
e.   Client “confirm” button to sign and broadcast transaction to ${Name}.
