# User Guide of Threshold Signature Scheme (TSS) in ${Name Chain}
...
* Mainnet: <https://github.com/${githubusername}/node-binary/tree/master/cli/prod/0.6.2-TSS-0.1.2>

* Testnet: <https://github.com/${githubusername}/node-binary/tree/master/cli/testnet/0.6.2-TSS-0.1.2>
