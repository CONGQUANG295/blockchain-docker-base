    ...
    "Trades": [
      {
        ...
        "SSrc": 0,
        "BSrc": 0,
        "SSingleFee": "${SYMBOL}:32042",
        "BSingleFee": "${SYMBOL}:32042",
        "TickType": 5,
      ...
      },
      {
        ...
        "SSrc": 0,
        "BSrc": 0,
        "SSingleFee": "${SYMBOL}:2111",
        "BSingleFee": "${SYMBOL}:2111",
        "TickType": 2,
...
```json
{
    "type": "record",
    "name": "Staking",
    "namespace": "org.${name}.dex.model.avro",
    "fields": [
            ...
            "values": {
                ...
                "items": {
                    ...
                    "fields": [
                        ...
                        {"name": "balance", "type": "org.${name}.dex.model.avro.Coin"}
                    ]
                }
            }
        }], "default": null},
            ...
            "values": {
                ...
                "items": {
                    ...
                    "fields": [
                        ...
                        {"name": "initialBalance", "type": "org.${name}.dex.model.avro.Coin" },
                        {"name": "balance", "type": "org.${name}.dex.model.avro.Coin" },
                        {"name": "minTime", "type": "long"}
                    ]
                }
            ...
            "values": {
                ...
                "items": {
                    ...
                    "fields": [
                        { "name": "validator", "type": "string" },
                        { "name": "delegator", "type": "string" },
                        { "name": "amount", "type": "org.${name}.dex.model.avro.Coin"}
                    ]
                }
            }
        }],  "default": null},
        ...
        {"name": "electedValidators", "type": ["null", {
            ...
            "values": {
                "type": "array",
                "items": "org.${name}.dex.model.avro.Validator"
            }
        }], "default": null}
    ]
}
