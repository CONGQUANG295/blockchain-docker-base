# ${Name Chain} Price Feeds from Chainlink
...
This section explains how to get the latest price of ${SYMBOL} inside smart contracts using Chainlink Price Feeds, on the ${Name Chain}.
...
const web3 = new Web3("https://testnet-rpc.${domainchain}");
...
web3 = Web3(Web3.HTTPProvider('https://testnet-rpc.${domainchain}'))
...
Chainlink price feed contracts are updated on a regular basis by multiple Chainlink nodes. This section lists the contract addresses for Price Feeds on the ${Name Chain}.

### Mainnet

| Pair      | Proxy                                                        |
| :-------- | :----------------------------------------------------------- |
| ${SYMBOL} / USD | [`0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE`](https://explorer.${domainchain}/address/0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE) |
| BTC / USD | [`0x264990fbd0A4796A3E3d8E37C4d5F87a3aCa5Ebf`](https://explorer.${domainchain}/address/0x264990fbd0A4796A3E3d8E37C4d5F87a3aCa5Ebf) |
| ETH / USD | [`0x9ef1B8c0E4F7dc8bF5719Ea496883DC6401d5b2e`](https://explorer.${domainchain}/address/0x9ef1B8c0E4F7dc8bF5719Ea496883DC6401d5b2e) |

Original source is from [Chainlink website](https://docs.chain.link/docs/${name}-smart-chain-addresses)
