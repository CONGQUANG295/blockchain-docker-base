# How to manually install the ${Name Chain} Extension Wallet

## Download the zip file

Visit https://${domainchain}/en/
...
Click **Chrome** and you will download the file `${NameChain}BrowserExtension-1.114.0.zip`
...
If you have any other questions, join https://t.me/${name}extensionwallet
