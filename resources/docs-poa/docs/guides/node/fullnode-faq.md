...
Since all the binaries are stored in `git lfs`, you will see this error is the binary is not complete. Please use this [script](https://github.com/${githubusername}/node-binary/blob/master/install.sh) to download the binaries or use `git lfs clone`.
