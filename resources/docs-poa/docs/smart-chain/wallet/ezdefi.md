# How to use ezDeFi for ${Name Chain}
...
## Getting the ${Name Chain} 
### On mobile app, go to "Setting" => "Advanced Setting" => "Custom RPC Network" to see default ${Name Chain} . On browser extension, go to "Setting" => "Network" to see default ${Name Chain} 
...
## Add ${SYMBOL} token in your wallet

### On mobile app, tap on the "Add more", search for "Smart Chain", tap on the "+" button and create new address of ${SYMBOL} token
###  On browser extension, click on "More Assets", search for "Smart Chain", select ${SYMBOL} token
...
### Back to mains creen to see ${SYMBOL} token already added on mobile app (or browser extension)
...
### ezDeFi Wallet is fully compatible with ${Name Chain} DApps.
### On mobile app
