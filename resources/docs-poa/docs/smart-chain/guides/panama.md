...
Introducing ${Name} Bridge, a bridge service providing access to inter-blockchain liquidity for ${Name Chain}, ${Name} Smart Chain decentralized applications, and bring valuable assets to ${Name Chain} ecosystems.
## Peg-In Procedure</b>
Peg-in procedure allows users to swap the native tokens to the equivalent of pegged tokens on ${Name Chain} or ${Name} Smart Chain. The following steps are taken:</b>

1. The user creates a Swap Request to ${Name} Bridge Service Provider
2. ${Name} Bridge Service Provider allocates a deposit address
...
4. ${Name} Bridge Service Provider will take notice of the upcoming transfer and send the equivalent pegged tokens to the receiver’s address
5. The user can see the change of his balance of these pegged tokens.
6. ${Name} Bridge Service Provider will lock the original tokens.
</b>
...
## Peg-Out Procedure</b>
Peg-out procedure allows users to swap the equivalent of pegged tokens on ${Name Chain} or ${Name} Smart Chain to the native tokens. The following steps are taken:</b>
...
4. ${Name} Bridge Service Provider will take notice of the upcoming transfer and send the equivalent native tokens to the receiver’s address

5. The user can see the change in his balance of these native tokens.

6. ${Name} Bridge Service Provider will lock the pegged tokens.
</b>
...
- BUSD Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/address/0xe9e7cea3dedca5984780bafc599bd69add087d56)
- USDT Token URL:
	-  [${Name Chain}](https://explorer.${domainchain}/address/0x55d398326f99059ff775485246999027b3197955)
- Pegged BTC Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c)
- Pegged ETH Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x2170ed0880ac9a755fd29b2688956bd959f933f8)
- Pegged LINK Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0xf8a0bf9cf54bb92f17374d9e9a321e6a111a51bd)
- Pegged BCH Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x8ff795a6f4d97e7887c79bea79aba5cc76444adf)
- Pegged ONT Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0xfd7b3a77848f1c2d67e05e54d78d174a0c850335)
- Pegged LTC Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x4338665cbb7b2485a8855a139b75d5e34ab0db94)
- Pegged ATOM Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x0eb3a705fc54725037cc9e008bdede697f62f335)
- Pegged DOT Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x7083609fce4d1d8dc0c979aab8c869ea2c873402)
- Pegged ADA Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x3ee2200efb3400fabb9aacf31297cbdd1d435d47)
- Pegged DAI Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3)
- Pegged EOS Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x56b6fb708fc5732dec1afc8d8556423a2edccbd6)
- Pegged BAND Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0xad6caeb32cd2c308980a548bd0bc5aa4306c6c18)
- Pegged XRP Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x1d2f0da169ceb9fc7b3144628db156f3f6c60dbe)
- Pegged XTZ Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x16939ef78684453bfdfb47825f8a5f714f12623a)
- Pegged BAT Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x101d82428437127bF1608F699CD651e6Abf9766E)
- Pegged SNX Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x9Ac983826058b8a9C7Aa1C9171441191232E8404)
- Pegged FYI Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x88f1A5ae2A3BF98AEAF342D26B30a79438c9142e)
- Pegged UNI Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0xBf5140A22578168FD562DCcF235E5D43A02ce9B1)
- Pegged FIL Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153)
- Pegged NEAR Token URL:
	- [${Name Chain}](https://explorer.${domainchain}/token/0x1Fa4a73a3F0133f0025378af00236f3aBDEE5D63)
- Pegged ZEC Token URL:
    - [${Name Chain}](https://explorer.${domainchain}/token/0x1ba42e5193dfa8b03d15dd1b86a3113bbbef8eeb)
- Pegged COMP Token URL:
    - [${Name Chain}](https://explorer.${domainchain}/token/0x52ce071bd9b1c4b00a0b92d298c512478cad67e8)
- Pegged MKR Token URL:
    - [${Name Chain}](https://explorer.${domainchain}/token/0x5f0da599bb2cccfcf6fdfd7d81743b6020864350)
- Pegged TCT Token URL:
    - [${Name Chain}](https://explorer.${domainchain}/token/0xca0a9df6a8cad800046c1ddc5755810718b65c44)
- Pegged IOTX Token URL:
    - [${Name Chain}](https://explorer.${domainchain}/token/0x9678e42cebeb63f23197d726b29b1cb20d0064e5)
- Pegged BEL Token URL:
    - [${Name Chain}](https://explorer.${domainchain}/token/0x8443f091997f06a61670b735ed92734f5628692f)
- Pegged ELF Token URL:
    - [${Name Chain}](https://explorer.${domainchain}/token/0xa3f020a5c92e15be13caf0ee5c95cf79585eecc9)
- Pegged PAX Token URL:
    - [${Name Chain}](https://explorer.${domainchain}/token/0xb7f8cd00c5a06c0537e2abff0b58033d02e5e094)
- Pegged USDC Token URL:
    - [${Name Chain}](https://explorer.${domainchain}/token/0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d)
- Pegged INJ Token URL:
    - [${Name Chain}](https://explorer.${domainchain}/token/0xa2B726B1145A4773F68593CF171187d8EBe4d495)
- SXP Token URL:
    - [${TOKENSTANDARD}20](https://explorer.${domainchain}/token/0xa2B726B1145A4773F68593CF171187d8EBe4d495)
    
Many more assets are coming soon ~

## Peg-in User Guide

- [Install ${Name} Extension Wallet](https://docs.${domainchain}/smart-chain/wallet/${name}.html) or [MetaMask](https://docs.${domainchain}/smart-chain/wallet/metamask.html)

- Go to [${Name} Bridge page](https://www.${domainchain}/en/bridge), Click on “Connect Wallet”
...
- Unlock your ${Name} Extension wallet or MetaMask to choose your destination address
...
- Install ${Name} Extension Wallet or MetaMask
- Go to swap page, click on the “Peg-out” tabClick on “Connect Wallet”

![img](https://lh5.googleusercontent.com/h8IwdUMVb7cLKxkeY6gb3H0xzAWqtl-ZIUsuQhQJ8W25e97BUInuMo7dibipPMgNyKsFobREoPbA4eNFbt2sPzkuFJurwHXCDCT-nPn9jpGmZpsMZ3KdiPCekJMfX-5_Vj_gJrZ6)

- Unlock your ${Name} Extension wallet or MetaMask to choose your source address.
Please note that you can only exchange your assets on **${Name Chain}** to their equivalents. Make sure that you have switched to ${Name Chain} network.
...
- You will have to transfer the exact amount of ${TOKENSTANDARD}20 tokens to an allocated address.
...
- ${Name Chain} Extension wallet will pop up a window for your approval.

Please double-confirm the destination address and amount.

To pay for the deposit transfer, you have to have enough ${SYMBOL} to pay for the **network fee**.
...
As ${Name Chain}'s average block time is about 3s, you should see the confirmation very soon.
...
- Mark your transaction hash in confirmation info, you can query the transaction in [${Name Chain} explorer](https://${domainchain}/) with the transaction hash.
...
## In Conclusion
Recently, ${Domainchain} [announced](https://www.${domainchain}/en/support/articles/daca7c991d5f4c45a4d1083f70912515) [Project Token Canal](https://www.${domainchain}/en/blog/${name}-presents-project-token-canal-2/), which is a new initiative, similar to many existing ‘wrapped coins’ in the crypto community. As the largest crypto token vault and exchange, ${Domainchain} will issue and bind more token assets on ${Name Chain} and ${Name} Smart Chain, and guarantee the conversion from and to the original tokens with credibility and infrastructure.

[Project Token Canal](https://www.${domainchain}/en/blog/${name}-presents-project-token-canal-2/) is a great option for users of ${Domainchain}, while ${Name} Bridge is the powerful alternative for non-${Domainchain} users and more. These two channels will work together to provide more liquidity to ${Name Chain} ecosystem. Peg-out feature will be available soon.
...
You can always track the status of their swaps at this [page](https://www.${domainchain}/en/bridge/history)
...
The address of ${Name Chain} and ${Name Chain} has different formats. In case of any kind of failure, please contact the customer support.

* What’s the fee structure for ${Name} Bridge Swap?
