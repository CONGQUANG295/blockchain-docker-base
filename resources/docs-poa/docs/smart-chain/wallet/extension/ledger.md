# How to use Ledger with ${Name} Extension Wallet
${Name} Extension Wallet v1.121.1 is released and verified on **Firefox and Chrome** with Ledger Nano S
...
* ${Name} Extension wallet v1.21.1 installed
...
2. Select and open the Ethereum Application. If you haven't installed Ethereum Application, please read this[ guide](https://docs.${domainchain}/smart-chain/wallet/ledger.html#app-installation-instructions)
3. Enabling contract data for ${TOKENSTANDARD}20. The first item in the settings menu is “Contract Data”. Push down both buttons to select it. Once you have set your ledger up like this the first time, you won’t have to do it again each time you want to use it with ${Name} Extension wallet.
4. Open ${Name Chain} Extension Wallet and select "${Name Chain}" network
...
!!! Warning
       Please note you cannot use Ledger account for ${Name Chain} network. 
...
![img](https://$name}.ghost.io/content/images/2020/12/image-5.png)
