# How to create a ${Name} wallet in Arkane

If you are looking for a user-friendly ${Name Chain} wallet, consider creating an Arkane wallet. It allows you to enable recovery mechanism and comes with end-user support via their in-app chat, making sure you are never lost in the wonderful land of cryptocurrency.
...
Navigate to [https://arkane.network](https://arkane.network/?utm_source=${name}&utm_medium=documentation) and click the 'YOUR WALLET'-button in the top right corner.
...
Now that you've configured your PIN, you are ready to create a ${Name Chain} wallet. Just select ${Name Chain} from the list.
...
You have now created your ${Name Chain} wallet to manage your digital assets on the ${Name Chain} blockchain. 




## Receive ${SYMBOL} and ${TOKENSTANDARD}20 tokens

Every ${Name} wallet in Arkane is able to send and receive ${SYMBOL} or ${TOKENSTANDARD}20 tokens. They will automatically  appear in your wallet.
...
## Resources:
* [${Name Chain} partners with Arkane](https://arkane.network/blog/${name}-smart-chain-partners-with-arkane?utm_source=${name}&utm_medium=documentation)
