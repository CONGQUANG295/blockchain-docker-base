# Use ${Name Chain} Extension Wallet
## What is it?
${Name Chain} Extension Wallet is a Crypto Wallet for ${Name Chain}, ${Name} Smart Chain. You can send and receive funds on ${Name Chain}, ${Name} Smart Chain and cross-chain transfers between both of ${Name}’s blockchains.

In the future, ${Name Chain} Extension Wallet will add support for Ethereum blockchain and enable access for distributed applications, or "Dapps" in your browser!
...
Chrome App Store Link: <https://chrome.google.com/webstore/detail/${name}-chain-wallet/fhbohimaelbohpjbbldcngcnapndodjp>

Firefox App Store Link: <https://addons.mozilla.org/en-US/firefox/addon/${name}-chain/?src=search>

[How to manually install the ${Name Chain} Extension Wallet](manual.md)


## Install

**Example: Install ${Name Chain} Wallet in Firefox browser**

* Open Extension in Firefox: <https://addons.mozilla.org/en-US/firefox/addon/${name}-chain/?src=search>
...
Note: Make sure it’s offered by ${Name Chain}
...
That’s it! You have successfully installed the ${Name Chain} Wallet extension in Firefox!


The workflow is the same for all browsers
## Create an account in extension wallet for ${Name Chain}
...
* Install ${Name Chain} extension by following the previous steps
...
## Get Testnet ${SYMBOL} from Faucet

* Go to <https://faucet.${domainchain}/>
...
* Switch to ${Name Chain} Testnet after unlock your extension wallet
...
* Paste your address in the box and click on “Give me ${SYMBOL}”
* Click on the “+” and add “${SYMBOL}” token
...
## Transfer Testnet ${SYMBOL} from ${Name} to BC
* Switch to ${Name Chain} testnet and copy your address after unlock your extension wallet, start with `tbnb1`
...
* Switch to ${Name Chain} testnet and click on “Send”
...
* Switch back to ${Name Chain} Testnet to confirm this cross-chain transfer
...
## Transfer Testnet ${SYMBOL} from BC to ${Name}

* Switch to ${Name Chain} testnet after unlock your extension wallet and copy your address, start with `0x`
...
## Swap Testnet ${TOKENSTANDARD}2 token to its ${TOKENSTANDARD}20 equivalent

* Follow the instructions above to Install ${Name Chain} extension wallet if not ready
* Follow the instructions above to create or Recover your account
* Switch to ${Name Chain} testnet after unlock your extension wallet and Click at “+” to add your ${TOKENSTANDARD}2 token if necessary
...
**Verify your balance has enough ${SYMBOL} to pay transfer fee**

* Switch to ${Name Chain} testnet and copy your address, start with `0x`

<img src="https://lh3.googleusercontent.com/kidAixmzNbNt_ujj0BQqZdZ4ZBXdEkxJLSVIOsWnWxZGOeXUJBjhxYsLlxH6VSQWxNX-dzqBFhqXSW3zmshkL99QYcVxIFGxw6tF7xF9ffXZPMPKnXlt0sWCKvPV6RMJWHSx1H0O" alt="img" style="zoom:33%;" />

Click at “+” to add your ${TOKENSTANDARD}20 token if necessary
...
* Switch to ${Name Chain} testnet, you should see your ${TOKENSTANDARD}20 token balance change
...
## Swap Testnet ${TOKENSTANDARD}20 token to its ${TOKENSTANDARD}2 equivalent

* Follow the instructions above to Install ${Name Chain} extension wallet if not ready
* Follow the instructions above to create or Recover your account
* Switch to ${Name Chain} testnet and Click at “+” to add your ${TOKENSTANDARD}20 token if necessary

<img src="https://lh5.googleusercontent.com/fW06aH1A5_7P93r8zSp4kgs5Us1AqYHvnfs6sRxg6aCLsQ7u9Ht_z6zLSExGjbr6J-D0vOmDWXghw544WhaNnkTP-nDAO3TFou5g_WYVvp7nOSrNX7w15PmvmZLyHkhBzLW_i-xi" alt="img" style="zoom:33%;" />

**Verify your balance has enough ${SYMBOL} to pay transfer fee**

* Switch to ${Name Chain} testnet and copy your address, start with `tbnb1`
...
* Click at “+” to add your ${TOKENSTANDARD}2 token if necessary
