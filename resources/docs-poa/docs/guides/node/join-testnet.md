...
wget https://raw.githubusercontent.com/${githubusername}/node-binary/master/fullnode/testnet/0.6.3-hotfix/config/genesis.json
```
...
If those seeds aren't working, you can find more seeds and persistent peers in the HTTP API endpoints: https://testnet-dex.${domainchain}/api/v1/peers
