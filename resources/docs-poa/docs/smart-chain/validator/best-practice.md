...
Please download the chain data [snapshot](https://github.com/${githubusername}/${name}-snapshots) and extract to your home folder to speed up



## Store your ${SYMBOL} with a hardware wallet
