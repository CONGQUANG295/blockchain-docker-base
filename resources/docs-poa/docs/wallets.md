...
* List of Wallets Supporting ${Name Chain} Mainnet
...
| 3      | [Ledger](wallets/ledger.md) (Hardware Wallet)          | <https://www.ledger.com/>        |Yes, via ${Domainchain} and Trubi|Yes, via ${Domainchain} and Trubi|Yes, via ${Domainchain} and Trubi|Yes, via ${Domainchain} and Trubi|
| 4      | [CoolWallet](wallets/cool-wallet.md) (Hardware Wallet) | <https://coolwallet.io/>         |Yes, via ${Domainchain} and Trubi|Yes, via ${Domainchain} and Trubi|Yes, via ${Domainchain} and Trubi|Yes, via ${Domainchain} and Trubi|
