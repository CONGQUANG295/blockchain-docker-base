...
import type { ChainIndicatorId, HeroBannerConfig, HomeStatsWidgetId } from 'src/slices/home/types/config';
import { HOME_STATS_WIDGET_IDS } from 'src/slices/home/types/config';
