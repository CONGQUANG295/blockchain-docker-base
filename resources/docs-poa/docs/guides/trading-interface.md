#  ${Name} DEX Trading Interface


${Name} DEX trading page is designed to provide a user-friendly trading interface to everyone. To get started, go to the trading page first at https://www.${domainchain}/trade. The trading page is composed of the following part:
...
- Balances: This section displays the current balance of your ${Name Chain} Wallet.

### Order Form
${Name} DEX currently only supports Limit orders. The Limit order section allows you to define the bid/ask price and the quantity you wish to trade. Please note that all order’s parameters’ constrains:
