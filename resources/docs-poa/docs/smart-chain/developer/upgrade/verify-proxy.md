...
*Please learn how to deploy an upgradable ${TOKENSTANDARD}20 contract [here](./proxy.md)*
...
```
$ truffle-flattener ${TOKENSTANDARD}20TokenImplementation.sol > ${TOKENSTANDARD}20TokenImplementationFlattened.sol
$ truffle-flattener ${TOKENSTANDARD}20UpgradeableProxy.sol > ${TOKENSTANDARD}20UpgradeableProxyFlattened.sol"
```
...
- Create new contract `${TOKENSTANDARD}20Token.sol` and copy contract code from flattened `${TOKENSTANDARD}20TokenImplementationFlattened.sol`
- Compile the implementation contract
- Click on this button to switch to the compile page
  - Select “${TOKENSTANDARD}20TokenImplementation” contract
...
- Click the “confirm” button to sign and broadcast the transaction to ${Name}.
...
- Create new contract proxy.sol and copy contract code from flattened `${TOKENSTANDARD}20UpgradeableProxyFlattened.sol `.  Here is and [example](https://explorer.${domainchain}/address/0xA6Ec2Fe4F6040b188A926048f44c9A59Fca189d4#code)
- Compile the proxy contractClick on this button to switch to the compile page
  - Select “${TOKENSTANDARD}20UpgradeableProxy” contract
  - Enable “Auto compile” and “optimization”Click “ABI” to copy the contract abi and save it.

### Deploy the proxy contract

- Select “Injected Web3”Select “${TOKENSTANDARD}20UpgradeableProxy.sol” contract
...
**Logic**: The address of `${TOKENSTANDARD}20Implementation` contract
**Admin**: admin cannot be ${TOKENSTANDARD}20 token owner
**Data**: use the initialization data you saved before

- Click the “Deploy” button and Metamask will pop up
- Click the “confirm” button to sign and broadcast transaction to ${Name}.

## Verify Proxy Contract on BscScan
Note: The way to verify the ${TOKENSTANDARD}20TokenImplementation contract is the same as before.
...
First, you need to copy ABI json of “${TOKENSTANDARD}20UpgradeableProxy.sol” contractThen, click on “Parse”
