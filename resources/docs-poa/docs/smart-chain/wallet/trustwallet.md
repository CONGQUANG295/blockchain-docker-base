# Using Trust Wallet for ${Name Chain}
...
### Your Smart Chain address is able to receive ${SYMBOL} or ${TOKENSTANDARD}20 tokens.

#### Withdraw ${Name Coin} (${SYMBOL}) from [${Name}](https://www.${domainchain}/). 
...
#### ${TOKENSTANDARD}20 tokens are also supported by Trust Wallet.
...
## Sending ${SYMBOL} to a Smart Chain address
...
### Trust Wallet is fully compatible with ${Name Chain} DApps.
...
## Resources:
* [Trust Wallet Now Supports ${Name Chain} (${SYMBOL})](https://community.trustwallet.com/t/trust-wallet-now-supports-${name-chain}-${symbol}/67250/3)
* [Trust Wallet supports ${TOKENSTANDARD}20 Tokens](https://community.trustwallet.com/t/trust-wallet-supports-${tokenstandard}20-tokens/69079/2)
* [Access ${Name Chain} DApps with Trust Wallet](https://community.trustwallet.com/t/access-${name-chain}-dapps-with-trust-wallet/70660/2)
