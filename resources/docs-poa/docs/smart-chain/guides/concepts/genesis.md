...
This document explains how the genesis file of the ${Name Chain} is structured.
...
**${MainnetId}** for main-net and **${TestnetId}** for test-net.  To compatible with third part service that already supports Ethereum, we’d better not use network id that Ethereum ecology that already used.  The network id of test-net should be distinct from main-net.
...
In ${Name Chain}, this value is always set to 0x0.
