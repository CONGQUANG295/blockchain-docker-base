...
Deploys a ${TOKENSTANDARD}20 smart contract with a message, and renders it in the front-end. You can interact with the smart contract easily!
...
- Create new contract ${TOKENSTANDARD}20Token.sol and copy contract code from the ${TOKENSTANDARD}20 token template [here](../${TOKENSTANDARD}20Token.template)
...
- Step2: Select “${TOKENSTANDARD}20Token” contract
...
Now, We have to deploy our smart contract on ${Name Chain} Network. For that, we have to connect to web3 world, this can be done my many services like Metamask, Brave, Portis etc. We will be using Metamask. Please follow this [tutorial to setup a Metamask Account](../../wallet/metamask.md).
...
* Testnet
        ...
        * ChainID: ${TestnetId}
        * Symbol: ${SYMBOL}
        * Block Explorer: https://testnet-explorer.${domainchain}

* Mainnet
        * [RPC URLs](../rpc.md)
        * ChainID: ${MainnetId}
        * Symbol: ${SYMBOL}
        * Block Explorer: https://explorer.${domainchain}
...
- Now, let's Deploy the Smart Contract on ${Name Chain} Testnet
...
**Congratulations!** You have successfully deployed a ${TOKENSTANDARD}20 Contract. Now you can interact with the Smart Contract. Check the deployment status here: <https://testnet-explorer.${domainchain}/>
