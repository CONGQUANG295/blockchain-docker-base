# Using Infinity Wallet on the ${Name Chain}
...
* ${SYMBOL} Page: <https://infinitywallet.io/asset/${name}>
...
* Now that you have created your wallet you can monitor and manage a wide range of different cryptos within the Infinity Wallet, including ${SYMBOL} and ${Name Chain} Tokens

<img src="https://i.gyazo.com/814d36df8afb29864b27df93ee50f095.png" width="640">


### Receive ${SYMBOL} on the ${Name Chain}

* To receive ${SYMBOL} on the ${Name Chain} you will have to enable it by going to **My Wallet** and clicking on **+ Add asset**, then select to enable **${Name Coin} (${SYMBOL})**. All **${Name}** tokens on the Infinity Wallet will use the same address as **${SYMBOL} ${Name}**

<img src="https://i.gyazo.com/033512c5c7d929596017243c05ad6648.png" width="640">


* Now that **${Name Coin}** is enabled go back to **My Wallet** and select **${Name Coin} (${SYMBOL})**, to get your receive adddress click on the receive button
...
### Send ${SYMBOL} on the ${Name Chain}

* To send go to **My Wallet**, select **${Name Coin}** and then click on the send button
...
Infinity Wallet supports the ability for users to connect securely to decentralized application on the ${Name Chain}, ${Name Chain} and Ethereum.
...
The Infinity Wallet is aiming to push crypto innovation to its limits and has a wide range of future features and UI enhancements on the roadmap, to further expedite global adoption of cryptocurrency. Along with its companion platform Infinity Crypto, which is revolutionizing the DeFi and exchange space on ${Name Chain} and Ethereum.
