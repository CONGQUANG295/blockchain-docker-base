...
Go to register and get API key: <https://explorer.${domainchain}/myapikey>
...
module.exports = {
  ...
  networks: {
    ...
    mainnet: {
      url: `https://mainnet-rpc.${domainchain}/`,
      accounts: {mnemonic: mnemonic}
    }
  },
  ...
  etherscan: {
    ...
    // Obtain one at https://explorer.${domainchain}/
...
contracts/${TOKENSTANDARD}20Token.sol:${TOKENSTANDARD}20Token at 0xbF39886B4F91F5170934191b0d96Dd277147FBB2
for verification on Etherscan. Waiting for verification result...

Successfully verified contract ${TOKENSTANDARD}20Token on Etherscan.
https://testnet-explorer.${domainchain}/address/0xbF39886B4F91F5170934191b0d96Dd277147FBB2#code
```
