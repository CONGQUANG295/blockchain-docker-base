...
${Name} and coins on ${Name Chain} are supported by the Trezor hardware wallet. The following describes how to use Trezor to connect to ${Name}.
...
${Name Chain} is compatible with MetaMask. Users can use MetaMask as a bridge between Trezor and ${Name Chain} to make transactions to the ${Name Chain} testnet.
