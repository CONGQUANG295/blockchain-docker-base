...
## How to delegate your ${SYMBOL} with extension wallet

- [Install ${Name Chain} extension wallet](${name}.md)
...
## How to redelegate your ${SYMBOL} with extension wallet

By staking you ${SYMBOL}, you participate in the selection process of ${Name Chain} validators and earn rewards. Staking ${SYMBOL} is critical for securing the network. Validators can self-bond, meaning they can delegate ${SYMBOL} to themselves, and they can also receive delegations from any other ${SYMBOL} holders.
...
## How to undelegate your ${SYMBOL} with extension wallet
