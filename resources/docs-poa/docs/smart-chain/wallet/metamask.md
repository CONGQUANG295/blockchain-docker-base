...
## Create an account in MetaMask for ${Name Chain}
...
## Connect Your MetaMask With ${Name Chain}
...
4. Go to faucet page: https://faucet.${domainchain}, then paste your address in the box and click on “Give me ${SYMBOL}”
...
## Transfer ${SYMBOL} to other ${Name Chain} address
...
2. Connect your ${Name Chain} Account to Remix</br>
...
To solve this issue, click on "'Settings" and enter Chain ID of ${Name Chain} network again. If **${MainnetId}** doesn’t work, try **${HexMainnetId}**. 
