# DIA Data Oracles on ${Name Chain}

## Introduction

DApp developers who want to leverage DIA oracles can access the published data on ${Name Chain}. DIA offers cryptocurrency and data about traditional financial assets.
...
|              W${SYMBOL} on PancakeSwap           |  Chart Point on Exchange |
...
The following snippet shows how to retrieve the BTC price of an asset (e.g. `${Name Coin}`) using a smart contract.
...
| :------------ | :------------------------------------------: | :----------: |
| ${Name}: Testnet | `0xf35bEE4B6727D2D1c9167C5fB4D51855D6bB693c` |    1/day    |
| ${Name}: Mainnet | `0xf35bEE4B6727D2D1c9167C5fB4D51855D6bB693c` |    1/day    |
