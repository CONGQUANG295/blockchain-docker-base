...
You can write your own smart contract or download the [${TOKENSTANDARD}20 token smart contract template](../${TOKENSTANDARD}20Token.template).

### Config Hardhat for ${Name}

- Go to hardhat.config.js
- Update the  config with ${name}-network-crendentials.
...
module.exports = {
  ...
  networks: {
    ...
    testnet: {
      url: "https://testnet-rpc.${domainchain}",
      chainId: ${TestnetId},
      gasPrice: 20000000000,
      accounts: {mnemonic: mnemonic}
    },
    mainnet: {
      url: "https://${name}-dataseed.${domainchain}/",
      chainId: ${MainnetId},
      gasPrice: 20000000000,
      accounts: {mnemonic: mnemonic}
    }
