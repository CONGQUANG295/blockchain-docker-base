# How to use Math Wallet for ${Name Chain}
## Install
...
####  Choose ${Name Chain} from this list:
...
It’s ready, and now you can get some testnet ${SYMBOL} from the faucet.
...
### 2. Go to <https://faucet.${domainchain}/>

Go to explorer to verify ${SYMBOL} is sent: <https://testnet-explorer.${domainchain}/>

## Transfer ${SYMBOL} from ${Name} to BC in Testnet

### 1. Create your ${Name Chain} Ganges Testnet address with eth-cli
* Download the binary [here](https://github.com/${githubusername}/node/releases/tag/v0.8.1)
> If you already have a backup of your recovery phrase from ${Name Chain} Ganges Testnet, it can be reused here.
```
...
Link: <https://explorer.${domainchain}/testnet>

## Transfer ${TOKENSTANDARD}20 from ${Name} to BC in Testnet

One of the key innovations of a dual-chain architecture is that token issuer can manage its assets on both chains. They could bind ${TOKENSTANDARD}2 tokens and ${TOKENSTANDARD}20 tokens together. In ${Name Chain} Ganges Testnet, there are several pegged tokens:

* Pegged BTC on [${Name Chain} Testnet](https://explorer.${domainchain}/testnet/asset/BTC-E24) and  [${Name} Smart Chain Testnet](https://testnet-explorer.${domainchain}/address/0x6ce8dA28E2f864420840cF74474eFf5fD80E65B8#code)
* Pegged ETH on  [${Name Chain} Testnet](
https://explorer.${domainchain}/testnet/asset/ETH-64F) and  [${Name} Smart Chain Testnet](https://testnet-explorer.${domainchain}/address/0xd66c6b4f0be8ce5b39d52e0fd1344c389929b378#code)
* Pegged XRP on  [${Name Chain} Testnet](
https://explorer.${domainchain}/testnet/asset/XRP-C46) and  [${Name} Smart Chain Testnet](https://testnet-explorer.${domainchain}/address/0xa83575490d7df4e2f47b7d38ef351a2722ca45b9#code)

You can get some of these pegged tokens from faucet and transfer them back to ${Name Chain} testnet.
...
### 2. Send ${TOKENSTANDARD}20 To BC![img](https://lh5.googleusercontent.com/_RKYU23BD2xhw-g63K8O3RRF1sEKGAC5zyTOIpWUJl9scDyn1kbjwEO6gjFPkVCeFMoG-8D0xvqNH17sJSlZP_FxCrduCqEKZqHfk8DtTnBk6XKHnHDLPAaR8VjVcNNWZsAw74FB)
