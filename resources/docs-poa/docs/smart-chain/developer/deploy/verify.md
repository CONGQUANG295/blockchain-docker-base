# How to Verify Your Contract on ${domainchain}

## Step 1: Deploy your contract on ${Name Chain}

## Step 2: Go to [${Name} Explorer](https://explorer.${domainchain}/) or [Testnet Explorer](https://testnet-explorer.${domainchain}/)
...
!!! info
	...
	The default ${TOKENSTANDARD}20 contract template does not have a constructor method
