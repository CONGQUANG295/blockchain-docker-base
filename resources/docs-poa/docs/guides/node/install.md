...
```
git lfs clonehttps://github.com/${githubusername}/node-binary.git
```

Please go to [changelog](https://github.com/${githubusername}/node-binary/blob/master/fullnode/Changelog.md) to get the information about the latest release of full node version.
