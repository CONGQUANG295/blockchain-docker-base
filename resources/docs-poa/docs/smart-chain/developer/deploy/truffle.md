...
You can write your own smart contract or download the ${TOKENSTANDARD}20 token smart contract template.
...
### Config Truffle for ${Name}

- Go to truffle-config.js
- Update the truffle-config with ${name}-network-crendentials.
...
module.exports = {
  networks: {
    development: {
      ...
      port: 8545,            // Standard ${Name} port (default: none)
...
Contract will be deployed on ${Name Chain} Chapel Testnet, it look like this:
...
**Congratulations!** You have successfully deployed ${TOKENSTANDARD}20 Smart Contract. Now you can interact with the Smart Contract.

You can check the deployment status here: <https://explorer.domainchain/> or <https://testnet-explorer.${domainchain}/>
