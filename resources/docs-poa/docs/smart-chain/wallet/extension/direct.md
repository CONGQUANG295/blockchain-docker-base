# [Wallet Direct](https://www.${domainchain}/en/wallet-direct) User Guide

## Key Features
- Seamless Token Transfer
Transfer tokens (which support BC/${Name}) between paired ${Domainchain} account and ${Name Chain} Wallet. Without the trouble of copy/paste address and memo every time
- ${SYMBOL} Holding
The ${SYMBOL} positions of your ${Domainchain} account will not change.
...
## User Guide
### Prerequisites
- ${Domainchain} Account SetupEnable two-factor authentication for your ${Domainchain} account (The balance cannot be zero)
- Install ${Name Chain} Extension WalletInstall the latest **v1.126.11** :
...
Click on “Connect to ${Domainchain} account”
...
The connected address display on this page: https://www.${domainchain}/en/wallet-direct 
...
- Unpair from [${Domainchain}](https://www.${domainchain}/en/wallet-direct)

<img src="https://lh4.googleusercontent.com/78UWTlOflzaiSipnOEoc0wKzl1x_4-si4QG-v4XWl3rf1-tFcV5Ug35PcwVS3Rgorabnee5KtZuOwTZKn0k-UBduTqQJEDJK2A-BSMxmNyDobvqvNOktLj5xB9tpg3d-1zd5UrBd" alt="img" style="zoom:33%;" />



Go to this page: https://www.${domainchain}/en/wallet-direct and click on “Disconnect‘, then your address is not connected anymore.
...
- Unpair from your ${Name} Extension wallet 
...
### How to Withdraw Tokens from ${Domainchain} to a paired account in Extension wallet?

1. Unlock your pairs account of ${SYMBOL} Extension wallet
...
3. Select one of your assets from the account balance of ${Domainchain}
...
### How to Deposit Tokens from your ${Name} Extension wallet account to a paired ${Domainchain} account?

1. Unlock your pairs account of ${Name} Extension wallet
